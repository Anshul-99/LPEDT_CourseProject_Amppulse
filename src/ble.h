...
/* Flag is set to true when indication is in flight for batterylevel characteristic and the device is
 * waiting for an ack from server */
bool indication_flight_flag_batterylevel;
/* Flag is set to true when indications for batterylevel characteristic is enabled by client device */
bool batterylevel_indication_enable;
