...
#define SL_SPIDRV_EXP_TX_LOC                     5

// USART1 RX on PA3
#define SL_SPIDRV_EXP_RX_PORT                    gpioPortA
#define SL_SPIDRV_EXP_RX_PIN                     3
#define SL_SPIDRV_EXP_RX_LOC                     2

// USART1 CLK on PA4
#define SL_SPIDRV_EXP_CLK_PORT                   gpioPortA
#define SL_SPIDRV_EXP_CLK_PIN                    4
#define SL_SPIDRV_EXP_CLK_LOC                    2

// USART1 CS on PB11
#define SL_SPIDRV_EXP_CS_PORT                    gpioPortB
#define SL_SPIDRV_EXP_CS_PIN                     11
#define SL_SPIDRV_EXP_CS_LOC                     3
// [USART_SL_SPIDRV_EXP]$
// <<< sl:end pin_tool >>>
