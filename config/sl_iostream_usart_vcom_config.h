...
#define SL_IOSTREAM_USART_VCOM_PERIPHERAL        USART2
#define SL_IOSTREAM_USART_VCOM_PERIPHERAL_NO     2

// USART2 TX on PF5
#define SL_IOSTREAM_USART_VCOM_TX_PORT           gpioPortF
#define SL_IOSTREAM_USART_VCOM_TX_PIN            5
#define SL_IOSTREAM_USART_VCOM_TX_LOC            18

// USART2 RX on PF6
#define SL_IOSTREAM_USART_VCOM_RX_PORT           gpioPortF
#define SL_IOSTREAM_USART_VCOM_RX_PIN            6
#define SL_IOSTREAM_USART_VCOM_RX_LOC            18
